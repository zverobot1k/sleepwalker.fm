        ...
        <section className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-glass-border mb-8">
              ...
              <span className="text-sm text-violet-300">{t('landingBadge')}</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-12">{t('landingSubtitle')}</p>
            <button
              onClick={() => {
                window.location.href = `${getApiBase()}/auth/spotify/login`;
              }}
